...
- [📖 [tv-movies] <a name="about-project"></a>](#-tv-movies-)
  ...
  - [🚀 Live Demo <a name="https://github.com/fezzopro/math-magicians/dist"></a>](#live-demo)
  - [💻 Getting Started <a name="getting-started"></a>](#-getting-started-)
    - [Prerequisites](#prerequisites)
    - [Setup](#setup)
    - [Install](#install)
    - [Usage](#usage)
  - [👥 Author <a name="authors"></a>](#authors)
...
```sh
  ...
  git clone https://github.com/fezzopro/math-magicians.git
  cd math-magicians
...
Feel free to check the [issues page](https://github.com/fezzopro/math-magicians/issues).
